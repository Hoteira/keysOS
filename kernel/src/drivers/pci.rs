...
pub const CAP_MSI: u8 = 0x05;     // Message Signaled Interrupts
pub const CAP_VENDOR: u8 = 0x09;  // Vendor Specific
pub const CAP_PCIE: u8 = 0x10;    // PCI Express
...
impl PciDevice {
    ...
    /// Get the capabilities list pointer
    ...
    /// Read a specific capability by offset
